...
namespace Subway.Player
{
    ...
    public class Movement : MonoBehaviour
    {
        ...
        IEnumerator SlideRoutine()
        {
            ...
            _velocity.x = Mathf.Sign(destinationX - transform.position.x) * _slideSpeed;
            ...
            {
                yield return null;
                completePath = Mathf.Lerp(0, LineOffsetX, Mathf.Abs(_velocity.x * t / LineOffsetX));
                t += Time.deltaTime;
            }
            _velocity.x = 0f;
            ...
            //Модифицированный старый скрипт
            /*_isSliding = true;
            var destinationX = _currentLine * LineOffsetX;
            _velocity.x = Mathf.Sign(destinationX - transform.position.x) * _slideSpeed;
